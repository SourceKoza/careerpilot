...
public class MissionExecutionService {
    ...
    private final com.sourcekoza.careerpilot.mission.repository.DiscoveredJobRepository discoveredJobRepository;
    private final MissionMapper missionMapper;
    private final com.sourcekoza.careerpilot.agent.email.EmailOutreachAgent emailOutreachAgent;
    ...
    public MissionExecutionService(MissionService missionService,
                                    ...
                                    com.sourcekoza.careerpilot.mission.repository.DiscoveredJobRepository discoveredJobRepository,
                                    MissionMapper missionMapper,
                                    com.sourcekoza.careerpilot.agent.email.EmailOutreachAgent emailOutreachAgent) {
    ...
    public MissionStartResponse runEmailOutreach(UUID userId, UUID missionId) {
        ...
        com.sourcekoza.careerpilot.agent.core.MissionContext context =
                new com.sourcekoza.careerpilot.agent.core.MissionContext(
    ...
    public Page<com.sourcekoza.careerpilot.mission.dto.DiscoveredJobResponse> getDiscoveredJobs(
